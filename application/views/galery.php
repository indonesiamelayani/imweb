<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="white-box">
            <h3 class="box-title m-b-0">Galeri</h3>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-default btn-rounded" data-toggle="modal" data-target="#modaledit<?php echo $id_galeri ?>" data-whatever="@mdo">
                                        Ubah
                                    </button>
                                    <button type="button" class="btn btn-danger  btn-rounded" data-toggle="modal" data-target="#modalhapus<?php echo $id_galeri ?>" data-whatever="@mdo">
                                        Hapus
                                    </button>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border-radius: 10px;">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel">Tambah Galeri</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?php echo base_url() ?>admin/galery/tambah" enctype="multipart/form-data">
                    <div class="white-box">
...
?>
    <!-- Modal Tambahh Edit -->
    <div class="modal fade" id="modaledit<?php echo $id_galeri ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius: 10px;">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="exampleModalLabel">Edit Galeri</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url() ?>admin/galery/edit" enctype="multipart/form-data">
                        <div class="white-box">
                            <h3 class="box-title">Unggah Foto</h3>
    ...
    <!-- Modal Hapus -->
    <div class="modal fade" id="modalhapus<?php echo $id_galeri ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="border-radius: 10px;">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="exampleModalLabel">Hapus Galeri</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url() ?>admin/galery/hapus">
                        <input type="hidden" name="id_galeri" value="<?php echo $id_galeri ?>">
                        <button type="button" class="btn btn-rounded btn-default" data-dismiss="modal">Close</button>
