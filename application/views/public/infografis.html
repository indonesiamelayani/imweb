      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto font-weight-bold">
            ...
            <a class="nav-item nav-link text-bold active" href="infografis.html">INFO GRAFIS</a>
        ...
        <div class="col-12">
          ...
          <div class="row">
            <div class="col-md-4 my-3">
              <img class="img-fluid" src="assets/img/logo-im.jpg" alt="">
              <h5 class="bg-danger text-white py-2 pl-2 mb-3">Info Keuangan</h5>
            </div>
            <div class="col-md-4 my-3">
              <img class="img-fluid" src="assets/img/logo-im.jpg" alt="">
              <h5 class="bg-danger text-white py-2 pl-2 mb-3">Info Kemiskinan</h5>
            </div>
            <div class="col-md-4 my-3">
              <img class="img-fluid" src="assets/img/logo-im.jpg" alt="">
              <h5 class="bg-danger text-white py-2 pl-2 mb-3">Info Bencana Alam</h5>
            </div>
            <div class="col-md-4 my-3">
              <img class="img-fluid" src="assets/img/logo-im.jpg" alt="">
              <h5 class="bg-danger text-white py-2 pl-2 mb-3">Info Keuangan</h5>
