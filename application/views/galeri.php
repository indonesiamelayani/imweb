...
//                                  var_dump($obj);
                            ...
                            <div class="row" style="margin-left:0px">
                                ...
                                <h4>Gambar <?php echo $i ?></h4>
                                    <input type="file" name="files[]" id="input-file-now-custom-3" class="dropify" style="border-radius: 8px;" data-height="110" data-default-file="<?php echo base_url() ?>files/<?php echo $value->img ?>" />
                                    <textarea class="form-control" name="val[]" style="border-radius: 8px;" rows="3"><?php echo$value->val ?></textarea>
                                </div>
                                <?php }?>
